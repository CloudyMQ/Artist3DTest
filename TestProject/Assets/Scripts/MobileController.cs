...
public class MobileController : MonoBehaviour, IDragHandler, IPointerUpHandler, IPointerDownHandler
{
    ...
    public virtual void OnDrag(PointerEventData ped)
    {
        ...
        {
            pos.x = (pos.x / joystickBG.rectTransform.sizeDelta.x);// ролучение координат позиции касаия на джойстик
            pos.y = (pos.y / joystickBG.rectTransform.sizeDelta.y);// ролучение координат позиции касаия на джойстик
